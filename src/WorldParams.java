...
public class WorldParams {
	...
	public static long safety_battery_time =(long)((time_of_battery/10)*60000); ;// safety time in mils
	public static double error_range = 0.02;
	public static int size_of_drone = 10;
