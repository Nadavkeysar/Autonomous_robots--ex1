...
public class AutoAlgo1 {
	...
	public void ai(int deltaTime) {
		...
		if (!is_risky) {
			...
			if (lidar.current_distance <= WorldParams.safety_distance + WorldParams.extra_range + WorldParams.lidarLimit) {//was max_risky_distance
				is_risky = true;
...
//
//	int isRotating;
//	ArrayList<java.lang.Double> degrees_left;
//	ArrayList<Func> degrees_left_func;
//
//	boolean isSpeedUp = false;
//
